...
import fanpeihua.justforfun.base.fbase.base.BaseActivity;
import fanpeihua.justforfun.cutomview.BrowserLayout;
import fanpeihua.justforfun.databinding.ActivityMyWebBinding;
import fanpeihua.justforfun.base.fbase.base.FBasePresenter;
import fanpeihua.justforfun.sonic.SonicRuntimeImpl;
import fanpeihua.justforfun.sonic.SonicSessionClientImpl;

public class  MyWebActivity extends BaseActivity<FBasePresenter, ActivityMyWebBinding> {
    ...
    protected void initEventAndData(Bundle savedInstanceState) {
        ...
        boolean isShowController = Config.TRUE.equals(mIsShowBottomBar);
...
//        offLineMode(sessionConfigBuilder);
    ...
    private void offLineMode(SonicSessionConfig.Builder sessionConfigBuilder) {
        ...
        sessionConfigBuilder.setConnectionInterceptor(new SonicSessionConnectionInterceptor() {
            ...
            public SonicSessionConnection getConnection(SonicSession session, Intent intent) {
                return new OfflinePkgSessionConnection(MyWebActivity.this, session, intent);
            }
        });
    }

    @Override
    protected FBasePresenter getPresenter() {
        return null;
    }
    ...
    public static void start(Context context, Activity preActivity,
        ...
        putParmToNextPage(BUNDLE_KEY_BOTTOM_BAR, isShowBottomBar ? Config.TRUE : Config.FALSE);
        putParmToNextPage(BUNDLE_KEY_OVERRIDE_URL, isOverrideUrlLoading ? Config.TRUE : Config.FALSE);
        toNextActivity(context, MyWebActivity.class, preActivity);
    }
    ...
    private class MonitorWebClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            //错误提示
            Toast toast = Toast.makeText(MyWebActivity.this.mContext, "Oh no! " + description + " " + failingUrl, Toast.LENGTH_LONG);
