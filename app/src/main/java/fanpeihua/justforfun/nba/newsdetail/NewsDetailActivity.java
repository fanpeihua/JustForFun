...
import fanpeihua.justforfun.base.fbase.utils.base.ToastUtils;
import fanpeihua.justforfun.base.fbase.utils.dialog.CustomDialog;
import fanpeihua.justforfun.base.fbase.utils.dialog.DialogInterface;
import fanpeihua.justforfun.base.fbase.utils.dialog.NormalSelectionDialog;
import fanpeihua.justforfun.base.fbase.utils.useful.PermissionManager;
import fanpeihua.justforfun.databinding.ActivityNewsDetailBinding;
import fanpeihua.justforfun.nba.bean.NewsDetail;
import fanpeihua.justforfun.utils.AnimatorUtil;
...
public class NewsDetailActivity extends BaseActivity<NewsDetailPresenter, ActivityNewsDetailBinding>
    ...
    public void getNewsDetail(NewsDetail newsDetail) {
        ...
        ImageLoader.displayImage(this, mImgurl, mBinding.ivNewsDetailCover);
        ...
        ImageLoader.displayImage(this, data.getImgurl(), mBinding.pvNewsDetailPic);
     ...
     */
    public void initPL() {
        mBinding.pl.setColor(mThemeColorMap.get(Config.ATTRS.COLOR_TEXT_LIGHT)
    ...
    private NormalSelectionDialog initDialog() {
        return new NormalSelectionDialog.Builder(NewsDetailActivity.this)
                ...
                .setItemTextColor(mThemeColorMap.get(Config.ATTRS.COLOR_PRIMARY))  //设置item字体颜色
