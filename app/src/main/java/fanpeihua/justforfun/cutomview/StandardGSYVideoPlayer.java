...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    protected void showVolumeDialog(float deltaY, int volumePercent) {
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(getActivityContext()).inflate(com.shuyu.gsyvideoplayer.R.layout.video_volume_dialog, null);
    ...
    protected void showBrightnessDialog(float percent) {
        if (mBrightnessDialog == null) {
            View localView = LayoutInflater.from(getActivityContext()).inflate(com.shuyu.gsyvideoplayer.R.layout.video_brightness, null);
