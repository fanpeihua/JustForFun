...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            changeStartButtonSize((int) getResources().getDimension(R.dimen.dp_62_x));
            ...
            tinyBackImageView.setVisibility(View.INVISIBLE);
            changeStartButtonSize((int) getResources().getDimension(R.dimen.dp_45_x));
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            ...
            mDialogVolumeImageView = ((ImageView) localView.findViewById(R.id.volume_image_trip));
